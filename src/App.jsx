...
function App() {
  ...
  const go = async () => {
    const res = await axios.get(
      "https://meshek-kirshner.co.il/wp-json/wc/v3/orders?consumer_key=ck_c46ca7077572152d70f72053920ec5d19e552ad1&consumer_secret=cs_3abdc6f2aeaf8f098a7497875e25430e6abdef29&status=processing&per_page=100"
    );
    setOrders(res.data);
  };
  useEffect(() => {
